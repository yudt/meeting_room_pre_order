<template>
	<el-dialog size="small" :title="title" @open="on_open" :before-close="cancel" :visible.sync="dialog_show">
		<div class="pre_order_time_bg">
			<el-date-picker size="large" v-model="timerange" format="yyyy-MM-dd HH:mm:ss" type="datetimerange" placeholder="选择日期时间" range-separator="至" start-placeholder="开始日期"end-placeholder="结束日期"></el-date-picker>
		</div>
